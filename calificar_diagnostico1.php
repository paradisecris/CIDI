...
<!--///////////////////////////////////////////////////Empieza cuerpo del documento interno////////////////////////////////////////////-->
		...
		<form class="form-inline">
                ...
                <button type="button" class="btn btn-info mb-2" onclick="buscaralumno($('#buscar').val(), $('#pphpagact').val(), $('#cboNumReg').val())">Buscar</button>
                <button type="button" class="btn btn-danger mb-2" onclick="history.go(0)" >X</button>
        </form>
            <div id="listado">
                <?php include 'listado_alumno.php'; ?>
            </div>
		</div>
...
<hr class="soften"/>
    ...
    <script src="bootstrap/js/bootstrap.min.js"></script>
     <script>
            function buscaralumno(cr, pa, re) {
                url = 'listado_alumno.php';
