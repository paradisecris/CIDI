...
<!--///////////////////////////////////////////////////Empieza cuerpo del documento interno////////////////////////////////////////////-->
        ...
        <ul class="nav pull-right">
        <a href="ver_report.php" target="_blank"><button type="button" class="btn btn-info">Imprimir</button></a>
        </ul>
		<div class="row-fluid">
		...
		<form class="form-inline">
                ...
                <button type="button" class="btn btn-info mb-2" onclick="buscarreportes($('#buscar').val(), $('#pphpagact').val(), $('#cboNumReg').val())">Buscar</button>
                <button type="button" class="btn btn-danger mb-2" onclick="history.go(0)" >X</button>
        </form>
            <div id="listado">
                <?php include 'listado_reports.php'; ?>
            </div>
		</div>
...
<hr class="soften"/>
    ...
    <script>
            function buscarreportes(cr, pa, re) {
                url = 'listado_reports.php';
