...
<!--///////////////////////////////////////////////////Empieza cuerpo del documento interno////////////////////////////////////////////-->
		...
		<ul class="nav pull-right">
		<a href="new_user.php"><button type="button" class="btn btn-success">Agregar +</button></a>
		</ul>
		<div class="row-fluid">
		...
		<form class="form-inline">
                ...
                <button type="button" class="btn btn-info mb-2" onclick="buscarusuario($('#buscar').val(), $('#pphpagact').val(), $('#cboNumReg').val())">Buscar</button>
                <button type="button" class="btn btn-danger mb-2" onclick="history.go(0)" >X</button>
        </form>
            <div id="listado">
                <?php include 'listado_user.php'; ?>
            </div>
		</div>
...
<hr class="soften"/>
    ...
    <script src="bootstrap/js/bootstrap.min.js"></script>
     <script>
            function buscarusuario(cr, pa, re) {
                url = 'listado_user.php';
